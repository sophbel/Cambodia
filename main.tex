...
{Age (months)}   & Mean (SD) & 17.779 (13.941) & 18.079 (13.736)    & 17.966 (13.804) \\
                                & Range     & 2-48            & 1-60               & 1-60            \\
{Vaccine Status} & NVT       & 107 (41.5\%)    & 230 (53.7\%)       & 337 (49.1\%)    \\
...
\end{table}
\begin{table}[hbt!]
\caption{Prevalence of antimicrobial non-susceptible isolates pre and post PCV13 in Cambodia for MDR (NS for 3 or more), penicillin (using the resistance threshold for meningitis), erythromycin, chloramphenicol, tetracycline, co-trimoxazole, and macrolides resistance: mef,ermB,cat, and tetM.}
